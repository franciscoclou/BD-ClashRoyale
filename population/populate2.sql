...
-- Shop
INSERT INTO
    Shop (shop_id, refresh_timestamp)
VALUES
    (1, '00:00:00'),
    (2, '12:00:00'),
    (3, '18:00:00');
...
-- ChestType
INSERT INTO
    ChestType (type_name, unlock_time_minutes)
VALUES
    ('Wooden', 1),
    ('Silver', 180),
    ('Gold', 480),
...
-- Clan
INSERT INTO
    Clan (clan_id, clan_name, flag_id, clan_trophies)
VALUES
...
-- Battle
INSERT INTO
    Battle (battle_id, battle_duration, crowns_total)
VALUES
    (1, 180, 3),
    (2, 120, 1),
    (3, 65, 3),
...
INSERT INTO
    Price (item_id, shop_id, price_value)
VALUES
    (3, 1, 100),
    (5, 1, 500),
    (14, 1, 50),
...
-- ChestInstance 
INSERT INTO
    ChestInstance (chest_id, type_name)
VALUES
    (201, 'Silver'),
    (202, 'Gold'),
    (203, 'Wooden'),
...
INSERT INTO
    PlayerArena (player_id, arena_id)
VALUES
    (10, 3),
    (20, 1),
    (30, 12),
...
-- PlayerClan
INSERT INTO
    PlayerClan (player_id, clan_id, clan_role)
VALUES
    (10, 1, 'Leader'),
    (20, 1, 'Member'),
    (30, 1, 'Builder'),
...
INSERT INTO
    PlayerChest (chest_id, player_id)
VALUES
    (201, 10),
    (202, 10),
    (203, 50),
...
INSERT INTO
    PlayerCardLevel (player_id, item_id, current_level)
VALUES
    --Cards Player ID:10
    (10, 20, 3),
    (10, 21, 3),
...
-- Deck
INSERT INTO
    Deck (deck_id, deck_number, average_elixir, player_id)
VALUES
    --Decks Player ID:10
    (101, 1, 3.1, 10),
    (102, 2, 2.9, 10),
